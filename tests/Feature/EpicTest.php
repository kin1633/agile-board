...
test('見積もりサマリーに直近3スプリントの平均ベロシティが含まれる', function () {
    ...
    // year/month の重複によるUNIQUE制約違反を防ぐため連番で割り当てる
    foreach ([[8, 2025, 1], [6, 2025, 2], [10, 2025, 3]] as [$points, $year, $month]) {
        $milestone = Milestone::factory()->create(['year' => $year, 'month' => $month]);
